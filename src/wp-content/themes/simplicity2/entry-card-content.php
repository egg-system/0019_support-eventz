...
-->
  <?php if ( get_theme_text_read_entry() || is_single()): //「記事を読む」のようなテキストが設定されている時 ?>
  <footer>
<!-- ーーーーーカスタマイズーーーーー -->

<!-- 濃い黄色箇所をバナー写真の下に表示する場合はここに記述する -->

        <?php endif; ?>

<!--
    <a href="<?php the_permalink(); ?>" class="entry-read-link"><?php echo get_theme_text_read_entry(); //記事を読む ?></a></p>
-->
  </footer>
