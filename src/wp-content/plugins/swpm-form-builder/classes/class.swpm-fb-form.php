...
class SwpmFbForm extends SwpmFbFormCustom {
    ...
    public function init_by_level_for_registration($membership_level) {
        ...
        if (empty($form_id)) {
            ...
            echo "<p style='color: red;'>If there is no form to catch a membership level then the plugin will fail to render the page and show the 'no from found' error.</p>";
            exit;
        }
